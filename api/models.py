...
class TranSum(models.Model):
    ...
    rate = models.DecimalField(max_digits=65, decimal_places=10, null=True, blank=True)
    sVal = models.DecimalField(max_digits=65, decimal_places=10, null=True, blank=True)
    sttCharges = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
    otherCharges = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
    noteAdd = models.CharField(max_length=200, blank=True)
    marketRate = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=Decimal('0.00'))
    ...
    HoldingValue = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    avgRate = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    ...
    clRate = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    clQTY = models.IntegerField(blank=True, null=True, default=0)
    clValue = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    clsttCharges = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    clOtherCharges = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    balQty = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    # balQty=models.IntegerField(blank=True,null=True,default=0)
    dayTrade = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
    strategyDate = models.DateField(null=True, blank=True)
    strategyTrigger = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True, default=0)
...
class MOS_Sales(models.Model):
    ...
    srate = models.DecimalField(max_digits=65, decimal_places=10)
    sqty = models.IntegerField()
    sVal = models.DecimalField(max_digits=65, decimal_places=10)
    stt_Paid = models.BooleanField(blank=True, null=True)
    stt = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
    other = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
    speculation = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
    stcg = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
    ltcg = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
    fno = models.DecimalField(max_digits=65, decimal_places=10, blank=True, null=True)
